...
save_path = os.path.dirname(os.path.realpath(__file__)) + '/a_1957_thick_3'
...
for i in range(1000):
    ...
    a += -0.1*((potential_energy - 0.95*potential_energy_new)/(0.95*potential_energy_new))
    ...
    if abs(1 - potential_energy / (0.95*potential_energy_new)) < 0.01:
        break
