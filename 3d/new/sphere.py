...
save_path = os.path.dirname(os.path.realpath(__file__)) + '/test_good_stock'
...
omega = 0
for particle in particles:
    omega += abs(particle.v - mean_vel) / abs(particle.r)
...
particles = create_sphere2(radii, lengths, mass=100)
